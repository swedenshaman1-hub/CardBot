...
def spread_caption() -> str:
    return (
        ...
        "Чтобы получить своё послание дня, подпишитесь на канал и нажмите номер выбранной карты ниже.\n"
        "Расшифровка придёт в личные сообщения от бота.\n\n"
        "Можно открыть до двух карт.\n"
        "После текста будет кнопка *«Прослушать послание»*.\n\n"
