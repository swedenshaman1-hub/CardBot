...
В админ-меню раздел «📖 Темы, итоги и напоминания» позволяет:

- задать тематическую неделю; семь следующих раскладов автоматически получают номер дня и короткий вопрос по теме;
- завершить тему досрочно;
- посмотреть и вручную подтвердить анонимный итог последнего расклада;
- записать, прослушать и отдельно подтвердить авторский голосовой итог недели.

После отклика на карту подписчик может добровольно включить напоминание о следующем раскладе или подготовить нейтральное приглашение для пересылки. Напоминание можно отключить той же кнопкой. Личные ответы и тексты рефлексии в аналитику не записываются.
